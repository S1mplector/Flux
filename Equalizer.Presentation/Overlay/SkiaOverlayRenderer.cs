...
public sealed class SkiaOverlayRenderer
{
    ...
    public void Render(SKCanvas canvas, int width, int height, VisualizerFrame frame, EqualizerSettings settings, ColorRgb? colorOverride = null)
    {
    ...
    private void RenderLinearBars(SKCanvas canvas, int width, int height, VisualizerFrame frame, float[] data, 
        EqualizerSettings settings, ColorRgb color, float fade)
    {
        var spacing = 2.0f;
